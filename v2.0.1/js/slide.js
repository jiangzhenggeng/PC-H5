/* project:project, version:test, update:Wed, 24 Sep 2014 02:41:42 GMT */
/*!
    ...
    $(document).ready(function(){
        ...
        function handleTab(e) {
            ...
            var target = e.currentTarget,
                index = $(target).index(),
                aBtn = $(target),
                aDiv = $(target).parent().parent().parent().find('.tabCont > div:eq('+index+')');
            if($('.selTeam').length){
                $('.selTeam').removeClass('on');
                $('.teamListSel .state').addClass('noDis');
            }
            $(target).parent().find('li').removeClass('on');
            $(target).parent().parent().parent().find('.tabCont > div').addClass('noDis');
            aBtn.addClass('on');
        ...
        function init() {
            ...
            if (document.querySelector('.topic-info')) {
                ...
                if (imgs.length > 1) {
                    ...
                    document.querySelector('.topic-info .oper').style.display = 'none';
                }            
            }
        }
